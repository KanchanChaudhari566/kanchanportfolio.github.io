...
<body>
    ...
    <header id="header">
        ...
        if($data['skype']!=""){
            ?>
                    <a href="https://web.whatsapp.com/7038624965" class="google-plus"><i class="bx bxl-whatsapp"></i></a>
                    <?php
        }
       ...
       if($data['skype']!=""){
            ?>
                    <a href="https://join.skype.com/invite/vcpzvzsGmAc9" class="google-plus"><i class="bx bxl-skype"></i></a>
                    <?php
        }
    ...
    ?>
                  <div class="col-lg-4 col-md-6 portfolio-item">
                        <div class="portfolio-wrap">
                            <img src="assets/img/<?=$data5['projectpic']?>" class="img-fluid" alt="" style="z-index: 20002;border-width: 7px;border-style: solid;border-color: #007bff;overflow: hidden; width:270px; height:200px;">
                            <div class="portfolio-links" title="<?=$data5['projectname']?>">
                                
                                <a href="assets/img/<?=$data5['projectpic']?>" data-gall="portfolioGallery" class="venobox" title="View"><i class="bx bx-plus"></i></a>
                                <a href="<?=$data5['projectlink']?>" target="_blank" title="Visit Website<?=$data5['projectname']?>"><i class="bx bx-link"></i></a>
                            </div>
                        </div>
                    </div>
                                <?php
...
-->
            <div class="credits">
                Developed by <a href="#">Kanchan Chaudhari</a>
            </div>
        </div>
    </footer><!-- End  Footer -->
